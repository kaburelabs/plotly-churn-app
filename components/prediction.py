...
def getting_input_parameters(btn_predict, btn_load_one, btn_load_all, gender, senior_citzen, partner, \
    ...
    permut_button=html.Div(html.Button(["Feature Weights"], id="btn-permutation", className="buttonStyle white"))
    permutation_importance=html.Div([
            ...
            html.Div([
                ...
                ], style={"margin": "16px auto"}), id="collapse-permutation-xai")
    ])
    ...
    if button_id == "btn-load-full":
        ...
        return html.Div([dash_result_component], className="result-layout"), dash.no_update, False
        ...
        will_churn=html.Span(["The model predicted that this customer ", html.B("WILL CHURN.")], className="bottom16"), html.Div(permut_button, className="top8")
        will_no_churn=html.Span(["The model predicted that this customer ", html.B("WILL NOT CHURN.")], className="bottom16"), html.Div(permut_button, className="top8")
