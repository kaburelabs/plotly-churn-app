...
prediction_layout=html.Div(
        [
            html.H1("IBM Customers Churn Prediction", className="text-center bottom64"), 
            ...
            dcc.Loading(html.Div(id="prediction-result"))
        ])
        ...
        html.Div([
            ...
            html.Div(dbc.Row(
                [
                    dbc.Col([
                        html.Div([
                            html.H3(["Demographic Features", html.Span(html.I(className="fas fa-question-circle font-sm"), 
                            ...
                            dbc.Row([
                                ...
                                dbc.Col(html.Div(
                                    [
                                        html.H4("Dependents", className="font-sm"),
                    ...
                    dbc.Col([
                        html.Div([
                            html.H3(["Contract settings", html.Span(html.I(className="fas fa-question-circle font-sm"), 
                                            style={"marginLeft":"5px"})], className="bottom16"),
                            html.Div(dbc.Row(
                                [
                                    dbc.Col(html.Div(
                                        [
                                            html.H4("Contract", className="font-sm"),
        ...
        html.Div([
            ...
            html.Div(dbc.Row(
                [
                    dbc.Col([
                        html.Div([
                            html.H3(["Service Features", html.Span(html.I(className="fas fa-question-circle font-sm"), 
                                            style={"marginLeft":"5px"})], className="bottom16"),
                            html.Div([dbc.Row(
                                [
                                    dbc.Col(html.Div(
                                    ...
                                    dbc.Col(html.Div(
                                        [
                                            html.Div([
                                                ...
                                                html.Span("More Services", className="font-sm")
                    ...
                    dbc.Col([
                        html.Div([
                            html.H3(["Tenure & Charges", html.Span(html.I(className="fas fa-question-circle font-sm"), 
                                            style={"marginLeft":"5px"})], className="bottom16"),
                            dbc.Row(
                                [
                                    dbc.Col(html.Div(
